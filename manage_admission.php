    ...
    if ($res) {
      if (mysqli_num_rows($res) > 0) {
        ...
        while ($row = mysqli_fetch_array($res)) {
          ...
          echo "<td>" . $row['role'] . "</td>";
          echo "<td>";	
                        echo '<a href="read.php?id='. $row['id'] .'" class="mr-3 btn btn-outline-info" title="Open Details" data-toggle="tooltip"><span class="fa fa-eye"></span></a> &nbsp;';
                        echo '<a href="update.php?id='. $row['id'] .'" class="mr-3 btn btn-outline-info" title="Update Details" data-toggle="tooltip"><span class="fa fa-pencil"></span></a> &nbsp;';
